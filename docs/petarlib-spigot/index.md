...
## Getting Started
:::warning
PetarLib-Spigot is still in development, and the API may change without deprecation. Use with caution and keep an eye on the changelog for updates.
:::
...
For server owners, simply download the latest release from the [Github Releases](https://github.com/PetarMc1/PetarLib-Spigot/releases)
